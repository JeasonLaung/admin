...
/**
 * ThinkPHP5.1.* Auth权限认证类
 * 数据表说明：
 *     建表语句在本类同级的tables.sql文件。
 *     建表时根据自身需要删除或替换[php4world_]表前缀
 *
...
class Auth
{
    ...
    protected $_config = [
        ...
        'auth_group'        =>  'php4world_auth_group',        // 用户组数据表名
        'auth_group_access' =>  'php4world_auth_group_access', // 用户-用户组关系表
        'auth_rule'         =>  'php4world_auth_rule',         // 权限规则表
        'auth_user'         =>  'php4world_master',            // 用户信息表
